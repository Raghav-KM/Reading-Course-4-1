...
public class MainActivity extends AppCompatActivity implements SensorEventListener {
    ...
    private TextView inclinationAngleTxt;
    ...
    private void initUI() {
        ...
        inclinationAngleTxt = findViewById(R.id.inclinationAngle_Txt);
    }
    ...
    public void onSensorChanged(SensorEvent sensorEvent) {
        ...
        if (sensorEvent.sensor.getType() == Sensor.TYPE_ACCELEROMETER) {
            ...
            if(isMonitoringOrientation){
                xReadingTxt.setText("X = " + Math.round(x));
                yReadingTxt.setText("Y = " + Math.round(y));
                zReadingTxt.setText("Z = " + Math.round(z));
                double inclinationAngle = Math.round(Math.toDegrees(Math.atan2(Math.sqrt(x * x + y * y), z)));
                inclinationAngleTxt.setText(inclinationAngle + "°");
            }else{
                xReadingTxt.setText("X = " + 0.0F);
                yReadingTxt.setText("Y = " + 0.0F);
                zReadingTxt.setText("Z = " + 0.0F);
                inclinationAngleTxt.setText(0 + "°");
